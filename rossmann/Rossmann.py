...
class Rossmann(object):
    def __init__(self):
        #self.home_path = '\\Users\\Cida\\Curso_DsEmProd\\'
    ...
    def feature_engineering(self, df2):
        ...
        # competition since
        # df2['competition_since']=df2.apply(lambda x: datetime.datetime(year=x['competition_open_since_year'],month=x['competition_open_since_month'],day=1),axis=1)
        df2['competition_since'] = df2['competition_open_since_year'].astype(str) + '-' + df2[
            'competition_open_since_month'].astype(str) + '-' + '1'
        df2['competition_since'] = pd.to_datetime(df2['competition_since'], format='%Y-%m-%d')
        ...
        # df2['promo_since']=df2['promo_since'].apply(lambda x: datetime.datetime.srtptime(x + '-1', '%Y%W%w') - datetime.timedelta(days=7))
